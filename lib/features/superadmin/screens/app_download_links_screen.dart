...
class _AppDownloadLinksScreenState extends State<AppDownloadLinksScreen> {
  static const _fields = [
    ...
    _Field('ubuntu', Icons.desktop_windows_outlined, 'Ubuntu / Linux App',
        'https://.../sawyunpos.deb', _Group.download),
    _Field('mac', Icons.desktop_windows_outlined, 'Mac App',
        'https://.../SawYunPos.dmg', _Group.download),
    _Field('print_agent', Icons.desktop_windows_outlined, 'Windows Print Agent',
        'https://.../sawyun-print-agent.exe', _Group.download),
